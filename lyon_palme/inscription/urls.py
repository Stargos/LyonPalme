...
urlpatterns = [
    ...
    path('accueil_secretaire', views.AccueilSecretaire, name='AccueilSecretaire'),
    ...
    path('accueil_secretaire', views.AccueilSecretaire, name='accueil_secretaire'),
    path('accueil_nageur', views.AccueilNageur, name='accueil_nageur'),
